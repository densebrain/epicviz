...
import {getValue, guard, isString} from "typeguard"
...
function hint(ts, cm, c) {
  ts.request(cm, {type: "completions", types: true, docs: true, urls: true}, function (error, data) {
    ...
    let tooltip = null
    let tooltipShouldClose = false
    let tooltipFocus = false
    const onTooltipFocus = (focus: boolean): void => {
      log.info("On tooltip", focus)
      tooltipFocus = focus
      if (!focus && tooltipShouldClose) {
        remove(tooltip)
      }
    }
...
function makeTooltip(x, y, content, onFocus: ((focus: boolean) => void) | null = null) {
